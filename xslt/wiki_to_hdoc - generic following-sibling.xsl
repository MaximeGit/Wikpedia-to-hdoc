...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="*" mode="divContent"/>
    ...
    <xsl:template match="//h2[following-sibling::h3 intersect following-sibling::h2[1]/preceding-sibling::h3]">
        <section>
            ...
            <xsl:apply-templates select="following-sibling::* intersect following-sibling::h2[1]/preceding-sibling::h3/preceding-sibling::* intersect following-sibling::h3[1]/preceding-sibling::*" mode="divContent"/>
    ...
    <xsl:template match="//h2[not(following-sibling::h3 intersect following-sibling::h2[1]/preceding-sibling::h3)]">
        <section>
            ...
            <xsl:apply-templates select="following-sibling::* intersect following-sibling::h2[1]/preceding-sibling::*" mode="divContent"/>
        </section>
    </xsl:template>
    ...
    <xsl:template match="//h2[not(following-sibling::* intersect following-sibling::h2[1]/preceding-sibling::*)]" mode="divContent"/>
    ...
    <xsl:template match="//h3">
        <section>
            ...
            <xsl:apply-templates select="following-sibling::* intersect following-sibling::h2[1]/preceding-sibling::* intersect following-sibling::h3[1]/preceding-sibling::*" mode="divContent"/>
    ...
    <!-- Paragraph template -->
    <xsl:template match="p" mode="divContent">
        <div>
    ...
    <!-- ul/li template -->
    <xsl:template match="ul" mode="divContent">
        <div>
             <xsl:element name="{local-name()}" namespace="http://www.utc.fr/ics/hdoc/xhtml">
